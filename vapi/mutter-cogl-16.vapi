/* mutter-cogl-16.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Cogl", gir_namespace = "Cogl", gir_version = "16", lower_case_cprefix = "cogl_")]
namespace Cogl {
	namespace Bits {
	...
	public class Onscreen : Cogl.Framebuffer {
		...
		public int64 get_frame_counter ();
		public virtual bool get_window_handles (void* device_out, void* window_out);
